...
export function Footer() {
  ...
  return (
    <footer id="contacto" style={{ backgroundColor: '#060606', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              >
                <span className="text-white text-lg font-black font-display">B</span>
              </div>
              <div>
                <p className="font-display font-bold text-white text-base leading-none">{restaurantConfig.name}</p>
          ...
          <div>
            ...
            <ul className="space-y-4 mb-6">
              <li className="flex items-start gap-2.5">
                ...
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>{restaurantConfig.address}</p>
              </li>
